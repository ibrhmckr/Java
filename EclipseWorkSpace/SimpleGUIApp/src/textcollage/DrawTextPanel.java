...
public class DrawTextPanel extends JPanel  {
	...
	ArrayList<DrawTextItem> theStrings = new ArrayList<DrawTextItem>(); 
	...
	private class Canvas extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			if (theStrings != null && theStrings.size() > 0) // Make sure theStrings is not empty
				theStrings.get(theStrings.size()-1).draw(g); // Gets the lastest item in the array
		}
	}
